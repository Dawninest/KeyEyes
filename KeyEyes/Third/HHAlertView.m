...
#define OKBUTTON_BACKGROUND_COLOR [UIColor colorWithRed:1.00 green:0.00 blue:0.00 alpha:1.00]
...
NSInteger const Mralertview_SIZE_DETAIL_FONT = 15;
...
- (instancetype)init
{
    self = [[HHAlertView alloc] initWithFrame:CGRectMake(0, ([self getMainScreenSize].height-Mralertview_SIZE_HEIGHT)/2 - 10, 375, Mralertview_SIZE_HEIGHT - 10)];
    self.alpha = 0;
    [self setBackgroundColor:[UIColor colorWithRed:1.00 green:1.00 blue:1.00 alpha:0.80]];
